"""
Skipper Python Client — REST API client for controlling Skipper remotely.
...
Note: This is the REST API *client* library.
      For writing Python agents that run inside Skipper, see skipper_sdk.py instead.
"""
...
class _Resource:
    def __init__(self, client: "Skipper"):
        self._c = client


class Skipper:
    """Skipper REST API client. Zero dependencies — uses only stdlib urllib."""
    ...
    def _request(self, method: str, path: str, body: Any = None) -> Any:
        ...
        try:
            ...
            raise SkipperError(f"HTTP {e.code}: {body_text}", e.code, body_text) from e
