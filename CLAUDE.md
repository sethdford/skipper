...
## Project Overview
Skipper is an open-source Agent Operating System written in Rust (14 crates).
- Config: `~/.skipper/config.toml`
- Default API: `http://127.0.0.1:4200`
- CLI binary: `target/release/skipper.exe` (or `target/debug/skipper.exe`)
...
## Architecture Notes
- **Don't touch `skipper-cli`** — user is actively building the interactive CLI
...
## Common Gotchas
- `skipper.exe` may be locked if daemon is running — use `--lib` flag or kill daemon first
