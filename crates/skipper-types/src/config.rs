//! Configuration types for the Skipper kernel.
...
impl Default for WebhookTriggerConfig {
    fn default() -> Self {
        Self {
            enabled: false,
            token_env: "SKIPPER_WEBHOOK_TOKEN".to_string(),
...
pub struct DockerSandboxConfig {
    ...
    pub image: String,
    /// Container name prefix. Default: "skipper-sandbox".
...
impl Default for DockerSandboxConfig {
    fn default() -> Self {
        Self {
            ...
            container_prefix: "skipper-sandbox".to_string(),
...
pub struct VaultConfig {
    ...
    pub enabled: bool,
    /// Custom vault file path (default: ~/.skipper/vault.enc).
...
pub struct KernelConfig {
    /// Skipper home directory (default: ~/.skipper).
    pub home_dir: PathBuf,
    /// Data directory for databases (default: ~/.skipper/data).
    ...
    /// Root directory for agent workspaces. Default: `~/.skipper/workspaces`
    #[serde(default)]
...
impl Default for KernelConfig {
    fn default() -> Self {
        let home_dir = dirs_next_home().join(".skipper");
        Self {
...
mod tests {
    ...
    fn test_validate_missing_env_vars() {
        ...
        config.channels.discord = Some(DiscordConfig {
            bot_token_env: "SKIPPER_TEST_NONEXISTENT_VAR_DC".to_string(),
            ..Default::default()
        });
        let warnings = config.validate();
