//! Shared error types for the Skipper system.

use thiserror::Error;

/// Top-level error type for the Skipper system.
#[derive(Error, Debug)]
...
/// Alias for Result with SkipperError.
pub type SkipperResult<T> = Result<T, SkipperError>;
