...
//! - Remote skills from SkipperHub registry
...
pub enum SkillSource {
    /// Built into Skipper or manually installed.
    Native,
    /// Bundled at compile time (ships with Skipper binary).
    Bundled,
