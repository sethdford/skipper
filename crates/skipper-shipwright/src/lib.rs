...
//! fleet orchestration with auto-scaling, and cross-Hand collaboration via Skipper's kernel.
//!
//! ### Core Components
//!
...
//!   cross-pollination to discover shared learning signals from other Skipper Hands.
//!
...
//!   bundled for Skipper's hand registry.
//!
...
//! ### Configuration
//!
//! Configure Shipwright in `skipper.toml`:
//!
//! ```toml
//! [shipwright]
//! enabled = true
...
//!
//! ```no_run
//! use skipper_shipwright::{Pipeline, pipeline::PipelineTemplate};
//!
