...
use skipper_shipwright::pipeline::self_healing::{BuildLoop, ProgressState};
...
fn build_loop_with_zero_max_iterations() {
    ...
    assert!(matches!(outcome, skipper_shipwright::pipeline::self_healing::BuildOutcome::Exhausted));
}
