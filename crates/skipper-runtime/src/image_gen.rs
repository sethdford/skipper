...
use base64::Engine;
use skipper_types::media::{GeneratedImage, ImageGenRequest, ImageGenResult};
use tracing::warn;
...
pub async fn generate_image(request: &ImageGenRequest) -> Result<ImageGenResult, String> {
    ...
    if request.model == skipper_types::media::ImageGenModel::DallE3 {
...
mod tests {
    use super::*;
    use skipper_types::media::ImageGenModel;
