// Skipper Visual Workflow Builder — Drag-and-drop workflow designer
'use strict';
...
function workflowBuilder() {
  return {
    ...
    async init() {
      ...
      try {
        var list = await SkipperAPI.get('/api/agents');
    ...
    async saveWorkflow() {
      ...
      try {
        await SkipperAPI.post('/api/workflows', {
          name: this.workflowName || 'untitled',
          description: this.workflowDescription || '',
          steps: steps
        });
        SkipperToast.success('Workflow saved!');
