...
const ETAG: &str = concat!("\"skipper-", env!("CARGO_PKG_VERSION"), "\"");
...
/// GET /logo.png — Serve the Skipper logo.
...
/// GET /favicon.ico — Serve the Skipper favicon.
...
/// GET / — Serve the Skipper Dashboard single-page application.
///
...
/// The embedded HTML/CSS/JS for the Skipper Dashboard.
///
...
const WEBCHAT_HTML: &str = concat!(
    ...
    "\n",
    include_str!("../static/js/pages/pipelines.js"),
    "\n",
    include_str!("../static/js/pages/fleet.js"),
    "\n",
    include_str!("../static/js/pages/memory.js"),
    "\n</script>\n",
