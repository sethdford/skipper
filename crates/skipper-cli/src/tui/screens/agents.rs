...
pub struct InProcessAgent {
    pub id: skipper_types::agent::AgentId,
    pub name: String,
    pub state: String,
    pub provider: String,
    pub model: String,
...
impl AgentSelectState {
    ...
    pub fn load_inprocess_agents(&mut self, kernel: &skipper_kernel::SkipperKernel) {
...
fn truncate(s: &str, max: usize) -> String {
    if s.len() <= max {
        ...
        format!("{}\u{2026}", skipper_types::truncate_str(s, max.saturating_sub(1)))
    }
}
